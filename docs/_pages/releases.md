...
* Added `BeEqualTo` and `NotBeEqualTo` to the collection assertions as a more fluent alternative to `Equal` - [#3166](https://github.com/fluentassertions/fluentassertions/pull/3166)
